...
let postObject = new Object({"content":encryptedPost,"date":new Date().getTime(),"tiers":checkedTiers})
  ...
  React.useEffect(()=>{
   ...
   {searchParams.get("status")=="success"?<Success/> :   <div>
    ...
    <form onSubmit={handleSubmit}>
      ...
      <input id="random-key" type="checkbox" defaultChecked="yes" onChange={()=>{setRandomKey(!randomKey)}}/>
      {randomKey?""
