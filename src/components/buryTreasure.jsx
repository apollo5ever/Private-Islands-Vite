...
export default function BuryTreasure() {
  ...
  const DoIt = React.useCallback(async (event) => {
    ...
    setSearchParams({"status": "metadata","name":event.target.bountyName.value})
  ...
  return (
    <div className="function">
      ...
      <form onSubmit={updateMetaData}>
        <input placeholder="Buried Treasure Name" id="bountyName" defaultValue={searchParams.get("name")}/>
        ...
        <p>Nominate a Judge. This person sorts through treasure claims and chooses who is entitled to the funds. The
          judge is paid 10% of the treasure for this work. Backup judges can be nominated later.</p>
