            ...
            <FlexBoxColumn align='left'>
              ...
              <FlexBoxRow justfy='between'>
                ...
                <form onSubmit={openSelectedWallet}>
                  <input id="pass" type="password" className='border border-slate-400 rounded-lg bg-zinc-800' placeholder='password' />
                  <Button type={"submit"} variant='outline' shape='circle' color='info' className='m-1 text-xs' >Open</Button>
                </form>
                
                <Button variant='outline' shape='circle' color='info' className='m-1 text-xs' onClick={() => closeSelectedWallet()}>Close</Button>
                <Button variant='outline' shape='circle' color='info' className='m-1 text-xs' onClick={() => removeSelectedWallet()}>Del</Button>
              </FlexBoxRow>
              <Divider />
        ...
        <Modal.Body>
          <FlexBoxColumn className='max-w-full'>
            ...
            <div className="w-full cursor-pointer">
              ...
              <div className="text-slate-200 p-4 border-2 hover:bg-secondary border-t-0 border-secondary" onClick={() => handleOptionClick("Create New Wallet")}>Create New Wallet</div>
              <div className="text-slate-200 p-4 border-2 hover:bg-secondary border-t-0 border-secondary" onClick={() => handleOptionClick("Recover From Seed")}>Recover From Seed</div>
              <div className="text-slate-200 p-4 border-2 hover:bg-secondary border-t-0 border-secondary" onClick={() => handleOptionClick("Recover From Hex Seed")}>Recover From Hex Seed</div>
              <div className="text-slate-200 p-4 border-2 hover:bg-secondary border-t-0 border-secondary" onClick={() => handleOptionClick("Recover From Disk")}>Recover From Disk</div>
            </div>
          </FlexBoxColumn>
        </Modal.Body>
      </Modal>
    ...
    switch (menuOption) {
      ...
      case "Recover From Seed":
        return <form onSubmit={handleSubmitSeed}>
          <input type="text" id="name" className='border border-slate-400 rounded-lg bg-zinc-800' placeholder="Name your wallet" />
          <input type="text" name="" id="seed" className='border border-slate-400 rounded-lg bg-zinc-800' placeholder="Enter your seed phrase" />
          <input type="password" id="pass" className='border border-slate-400 rounded-lg bg-zinc-800' placeholder="Enter a password" />
          <input type="password" id="conf" className='border border-slate-400 rounded-lg bg-zinc-800' placeholder="Confirm password" />
          <Divider />
