  ...
  return (
    <FlexBoxRow className=''>
      <FlexBoxColumn className=''>
        <div className="icons-treasure" onClick={() => handleClick({filter: "treasure"})} />
        <div className="">Bounties</div>
      </FlexBoxColumn>
      <FlexBoxColumn>
        <div className="icons-signal" onClick={() => handleClick({filter: "smokesignals"})} />
        <div className="icons-text">Fundraisers</div>
      </FlexBoxColumn>
      <FlexBoxColumn>
        <div className="icons-mail" onClick={() => handleClick({filter: "mib"})} />
