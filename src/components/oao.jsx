    ...
    <div>
      <div className="function">
        <div>
          ...
          <p>Your Seat (#{ID}) {expires < 0 ? <>is expired</> : <>expires in {expires} days</>};Seats
            Filled: {12 - vacant}/12; Total Votes: {voteIndex};{balanceList}{allowanceList}</p>

          <div className="function">
            {status == 0 ? <>
                <p> Motion
                  to {type === 0 ? "hire " + address + " as new CEO" : type === 1 ? "fire CEO" : type === 2 ? "add " + address + " as board member " + AOS : type === 3 ? "remove " + address + " from seat " + AOS : type === 4 ? "set weekly allowance of " + address + " to " + AOS / 100000
                ...
                <form onSubmit={castVote}>
                  ...
                  <Button size='small' type={"submit"}>Cast Vote</Button>
                </form>
                <Button size='small' handleClick={() => closeVote()}>Close Vote</Button>
              </>
              : <>
                <h3> Open a Vote </h3>
                <form onSubmit={openVote}>
                  ...
                  <Button size='small' type={"submit"}>Open Vote</Button>
                </form>
              </>}
          </div>
          ...
          <div className="function">
            ...
            <form onSubmit={checkVote}>
              ...
              <Button size='small' type={"submit"}>Check Vote</Button>
            </form>
            {type === 5 ?
              ...
              <form onSubmit={hashCode}>
                ...
                <Button size='small' type={"submit"}>Check Hash</Button>
              </form>
              : ""
            }
          </div>
          ...
          <div className="function">
            ...
            <form onSubmit={transferSeat}>
              ...
              <Button size='small' type={"submit"}>Transfer Seat</Button>
            </form>
          </div>
        </div>
      </div>
