...
{executing.length>0?<><h3>Nominated for Executer</h3><div className="card-grid">
          ...
          <div className="icons">
               <div className="icons-treasure" onClick={()=>{setView("treasure")}}><div className="icons-text">Bounties</div></div><div className="icons-signal" onClick={()=>{setView("signal")}}><div className="icons-text">Fundraisers</div></div><div className="icons-mail" onClick={()=>{setView("mail-in")}}><div className="icons-text">Subscriptions</div></div>
          </div>
