...
const WalletMenu = ({ handleClose }) => {
  ...
  const handleSubmitSeed = async (e) => {
    ...
    localStorage.setItem(
      `wallet-${state.walletList.length}-${wallet.name}`,
    ...
    return (
      ...
      : "select"}
        ...
        <div>
          ...
          <Info />
          <button onClick={() => handleOptionClick('addWallet')}>
            Add Wallet
          </button>
      ...
      <div className="menu">
        ...
        <div className="menu-options">
          <div
            ...
            onClick={() => handleOptionClick('Create New Wallet')}
          >
            Create New Wallet
          </div>
          <div
            className="menu-option"
            onClick={() => handleOptionClick('Recover From Seed')}
          >
            Recover From Seed
          </div>
          <div
            className="menu-option"
            onClick={() => handleOptionClick('Recover From Hex Seed')}
          >
            Recover From Hex Seed
          </div>
          <div
            className="menu-option"
            onClick={() => handleOptionClick('Recover From Disk')}
          >
            Recover From Disk
          </div>
        </div>
  ...
  return menuOption === 'main'
    ? renderMainMenu()
    : menuOption === 'addWallet'
    ? renderAddWalletMenu()
    : renderOptionMenu();
};
